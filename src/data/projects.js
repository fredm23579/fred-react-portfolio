const projects = [
  {
    ...
    tech: ['Node.js', 'JavaScript', 'OpenAI API', 'Anthropic Claude', 'Google Gemini', 'Perplexity', 'xAI Grok', 'Meta Llama', 'OAuth2'],
    category: 'AI/ML',
  ...
  },
  {
    ...
    tech: ['React 18', 'Node.js', 'Express', 'MongoDB', 'GraphQL', 'Apollo Server 4', 'Apollo Client 3', 'Stripe', 'JWT', 'Vite 6', 'PWA', 'Workbox'],
    category: 'Full-Stack',
  ...
  },
  {
    ...
    tech: ['React', 'MongoDB', 'Express.js', 'Node.js', 'GraphQL', 'Apollo Client', 'Apollo Server', 'JWT', 'Vite'],
    category: 'Full-Stack',
  ...
  },
  {
    ...
    tech: ['Node.js', 'Express.js', 'MySQL', 'Sequelize ORM', 'Handlebars', 'bcrypt', 'MVC Architecture'],
    category: 'Full-Stack',
  ...
  },
  {
    ...
    tech: ['JavaScript', 'HTML5', 'CSS', 'Google Maps API', 'Google Places Library', 'Dog API', 'Foundation CSS', 'jQuery', 'Geolocation API'],
    category: 'Frontend',
  ...
  },
  {
    ...
    tech: ['Node.js', 'Express.js', 'Sequelize ORM', 'MySQL', 'Handlebars', 'bcrypt', 'dotenv'],
    category: 'Full-Stack',
